...
"[project]/src/app/api/hotel/bills/add/controller.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: require } = __turbopack_context__;
{
__turbopack_esm__({
    "add_whole_bill": (()=>add_whole_bill)
});
...
;
;
async function add_whole_bill(data, tokenData) {
    try {
        // Verify if user has permission to create hotels
        if (!tokenData || !tokenData.hotelId || !tokenData.role || !tokenData.hotelId || ![
            'Backoffice',
            'Owner'
        ...
        if (customer_name !== null) {
            const customer_exists = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$Customers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].checkCustomer(customer_name, contact, hotel_id);
            if (customer_exists.returncode !== 200 || customer_exists.output.length === 0 || customer_exists.output === null) {
                ...
                const customer_result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$Customers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createCustomer(customerData);
        ...
        const bill_result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$Bills$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createBill(billData);
        ...
        await menu_data.forEach(async (order)=>{
            ...
            const order_result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$Orders$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].addOrder({
                quantity,
                note,
                status,
                total_amount,
...
"[project]/src/app/api/hotel/bills/add/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$hotel$2f$bills$2f$add$2f$controller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/api/hotel/bills/add/controller.js [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$hotel$2f$bills$2f$add$2f$controller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["add_whole_bill"])(data, userData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2cda77._.js.map