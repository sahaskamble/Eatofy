...
"[project]/src/app/hotel/(dashboard)/backup/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$CheckCircleIcon$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircleIcon$3e$__ = __turbopack_import__("[project]/node_modules/@heroicons/react/24/outline/esm/CheckCircleIcon.js [app-ssr] (ecmascript) <export default as CheckCircleIcon>");
'use client';
;
;
;
...
;
function BackupPage() {
    const [pendingBackups, setPendingBackups] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const checkPendingBackups = async ()=>{
        ...
        try {
            const backupChecks = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Customers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].checkPendingBackups(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Menus$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].checkPendingBackups(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$MenuCategory$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].checkPendingBackups(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Sections$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].checkPendingBackups(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Tables$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].checkPendingBackups(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Staffs$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].checkPendingBackups()
            ]);
            const pending = [];
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Error checking pending backups');
            console.error(error);
        } finally{
            setIsLoading(false);
        }
    ...
    const handleBackup = async (type)=>{
        try {
            ...
            switch(type){
                case 'Customers':
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Customers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].syncToServer();
                    break;
                case 'Menus':
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Menus$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].syncToServer();
                    break;
                case 'Menu Categories':
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$MenuCategory$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].syncToServer();
                    break;
                case 'Sections':
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Sections$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].syncToServer();
                    break;
                case 'Tables':
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Tables$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].syncToServer();
                    break;
                case 'Staff':
                    result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$offline$2f$crud$2f$Staffs$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].syncToServer();
                    break;
                default:
                    throw new Error('Invalid backup type');
            }
            if (result.returncode === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`${type} backed up successfully`);
                checkPendingBackups(); // Refresh the pending backups list
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(result.message || `Failed to backup ${type}`);
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$react$2d$toastify$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Error backing up ${type}`);
            console.error(error);
        }
    };
    if (isLoading) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: pendingBackups.map((backup, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/src/app/hotel/(dashboard)/backup/page.js [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
{
__turbopack_esm__({
    "CheckCircleIcon": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$CheckCircleIcon$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$CheckCircleIcon$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@heroicons/react/24/outline/esm/CheckCircleIcon.js [app-ssr] (ecmascript)");
}}),

};

//# sourceMappingURL=_0870bf._.js.map