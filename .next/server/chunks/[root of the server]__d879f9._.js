...
"[project]/src/app/api/hotel/settings/vat/add/controller.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function add_settings(data, tokenData) {
    try {
        ...
        const existing_settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$VATSettings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].readSettings(hotel_id);
        if (existing_settings.returncode === 200 || existing_settings.output.length > 0) {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$VATSettings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateSettings({
                hotel_id,
                visibility,
                vat_percent
            });
        ...
        // Create VAT Settings
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$VATSettings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].addSettings({
            hotel_id,
            visibility,
            vat_percent
        });
...
"[project]/src/app/api/hotel/settings/vat/add/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$hotel$2f$settings$2f$vat$2f$add$2f$controller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/api/hotel/settings/vat/add/controller.js [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$hotel$2f$settings$2f$vat$2f$add$2f$controller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["add_settings"])(data, userData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d879f9._.js.map