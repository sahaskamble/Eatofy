...
"[project]/src/app/api/hotel/auth/login/controller.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const login_hotel = async (data)=>{
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$crud$2f$Staffs$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].login(email, password);
        return result;
    } catch (error) {
        return {
            returncode: 500,
...
"[project]/src/app/api/hotel/auth/login/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$hotel$2f$auth$2f$login$2f$controller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/api/hotel/auth/login/controller.js [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$hotel$2f$auth$2f$login$2f$controller$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["login_hotel"])(data);
        if (result.returncode === 200 && result.output.length > 0) {
            // Create JWT token with hotel data
            const userData = result.output[0];
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$utils$2f$jwt$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createToken"])({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e1babd._.js.map