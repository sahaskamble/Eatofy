  ...
  const handleUpdateMenu = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        console.log("Error on Saving Bill");
        setIsOrderFailed(true);
        setTimeout(() => {
          setIsOrderFailed(false);
        }, 2000);
    ...
    <>
      ...
      {isLoading ? (
        ...
        <div className="ml-[70px] flex px-0 overflow-hidden bg-white">
                          ...
                          return (
                            <div key={index} className="flex p-2 grayscale">
                              <div className="flex-1 inline-flex justify-start items-center gap-3">
                                <div className="w-[30px] h-[30px] bg-red-400 inline-grid place-items-center rounded-md">
          ...
          <div
            ref={billkot}
            className="max-w-md mx-auto p-4 border border-zinc-300 rounded-md bg-white text-black fixed left-0 top-[50dvh] z-[-500]"
          >
