      ...
      <div>
        ...
        <div className="bg-white text-black min-h-screen p-6">
          <header className="w-[80%] bg-red-500 text-white py-4 mb-6 mx-auto text-center rounded-xl">
            <h1 className="text-xl font-bold">/Features/Staff Management</h1>
          </header>
          <main className="w-[70%] mx-auto">
            <div
              style={{ backgroundImage: "url(/staff.png)", backgroundSize: "cover" }}
              ...
              <div className="flex-1">
                <section className="mb-8">
                  <p className="text-lg leading-relaxed">
                    Our Staff Management service helps you streamline your team’s operations with powerful tools for scheduling, performance tracking, and communication. Designed to enhance efficiency and coordination within your team, this service ensures that your staff is well-managed and productive.
                  </p>
                </section>
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold mb-4">How It Works:</h2>
                  <p className="text-lg leading-relaxed">
                    Our Staff Management system integrates seamlessly with your existing operations. You can schedule shifts, assign tasks, and track performance through a user-friendly dashboard. Our system provides real-time updates and notifications to keep you and your team informed and organized.
                  </p>
                </section>
                <section className="mb-8">
                  <h2 className="text-2xl font-semibold mb-4">Benefits of Using Our Service:</h2>
                  <p className="text-lg leading-relaxed">
                    By utilizing our Staff Management tools, you can optimize staff scheduling, enhance productivity, and improve team coordination. Our service simplifies administrative tasks and helps you focus on growing your business while keeping your team engaged and motivated.
                  </p>
                </section>
              </div>
              <section className="mb-8">
