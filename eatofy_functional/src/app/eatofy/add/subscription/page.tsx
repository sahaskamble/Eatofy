...
export default function Subscription() {
	...
	return (
		<>
						...
						<div className="flex flex-col lg:flex-row">
							...
							<div className="lg:w-1/2 lg:pr-4">
								<div className="flex flex-row justify-between items-center mb-8 space-y-4">
									...
									<button onClick={ShowForm} className="bg-red-500 hover:bg-red-600 p-2 rounded-lg">+Add Subscription</button>
								</div>
							...
							<div className="lg:w-1/2 lg:pl-4">
								...
								<div className="mb-8">
									...
									<button className="bg-red-500 hover:bg-red-600 p-2 w-full rounded-[50px]">View full list</button>
								</div>
								<button onClick={ShowFormtaks} className="bg-black p-3 text-white rounded-lg">
									add tasks
								</button>
										...
										tasks.map((items: any, i: any) => (
											<div key={items.id} className="flex items-center justify-between my-4">
												...
												<button onClick={
													...
													className="p-2 bg-black text-white rounded-lg">delete</button>
											</div>
										))
									}
								</div>
			...
			<section ref={task} className="ml-[60px] hidden fixed top-0 left-0 w-full h-full text-white flex bg-white justify-center items-center bg-gradient-to-tr from-red-500 to-zinc-800 ">
				<form encType="multipart/form-data" method="POST" onSubmit={fetchTasksadd} className="w-[80%] bg-black bg-opacity-30 h-[80%] flex flex-col justify-center items-center gap-6 rounded-md shadow-md shadow-zinc-800">
					<div className="w-[60%]">
						<label>tasks</label>
						<input
							type="text"
					...
					<div className="flex justify-between items-center w-[60%] px-3 py-6 ">
						<button type="submit" className="bg-red-500 hover:bg-red-600 text-white font-bold p-3 rounded-md border border-red-400">
							Add tasks
						</button>
						<button type="button" onClick={ShowFormtaks} className="p-3 my-4 mr-4 bg-black text-white w-[100px] rounded-md">
							close
						</button>
					</div>
				</form>
			...
			<section ref={form} className="ml-[60px] hidden fixed top-0 left-0 w-full h-full text-white flex bg-white justify-center items-center bg-gradient-to-tr from-red-500 to-zinc-800 ">
				<form encType="multipart/form-data" onSubmit={handleSubmit} className="w-[80%] bg-black bg-opacity-30 h-[80%] flex flex-col justify-center items-center gap-6 rounded-md shadow-md shadow-zinc-800">
					...
					<div className="flex justify-between items-center w-[60%] px-3 py-6 ">
						...
						<button type="button" onClick={ShowForm} className="p-3 my-4 mr-4 bg-black text-white w-[100px] rounded-md">
							close
						</button>
					</div>
				</form>
